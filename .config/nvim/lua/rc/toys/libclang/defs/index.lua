...
typedef enum {
  ...
  CXGlobalOpt_ThreadBackgroundPriorityForAll =
      ...
      CXGlobalOpt_ThreadBackgroundPriorityForEditing} CXGlobalOptFlags;
...
enum CXTUResourceUsageKind {
  ...
  CXTUResourceUsage_MEMORY_IN_BYTES_END =
      CXTUResourceUsage_Preprocessor_HeaderSearch,  CXTUResourceUsage_First = CXTUResourceUsage_AST,
...
typedef struct CXTUResourceUsage {
  void *data;  
  unsigned numEntries;  
  CXTUResourceUsageEntry *entries;} CXTUResourceUsage;
...
enum CXTypeKind {
  ...
  CXType_Atomic = 177,
  CXType_BTFTagAttributed = 178,  // HLSL Intangible Types
...
unsigned clang_defaultCodeCompleteOptions(void);CXCodeCompleteResults *
...
typedef enum {
  CXResult_Success = 0,
  CXResult_Invalid = 1,
  CXResult_VisitBreak = 2} CXResult;
...
typedef struct {
  ...
  int isImplicit;
  const CXIdxAttrInfo *const *attributes;
  unsigned numAttributes;  unsigned flags;
} CXIdxDeclInfo;
...
typedef struct {
  ...
  void (*diagnostic)(CXClientData client_data, CXDiagnosticSet, void *reserved);  CXIdxClientFile (*enteredMainFile)(CXClientData client_data, CXFile mainFile,
                                     void *reserved);  
...
typedef enum {
  ...
  CXIndexOpt_SkipParsedBodiesInSession = 0x10} CXIndexOptFlags;
